...
window.addEventListener('DOMContentLoaded', async function () {
    ...
    facturaForm.addEventListener('submit', async function(event) {
        ...
        divFacturaGasto = document.getElementById("factura_gasto");
        ...
        await fetch('/gastos/nuevo', opcionesRequest)
            .then(response => {
                //console.log(response)
                if(document.getElementById(divAlerta.id)) divFacturaGasto.removeChild(document.getElementById(divAlerta.id));
                if (response.ok === true){
                    ...
                    divFacturaGasto.prepend(divAlerta); // prepend para ponerlo como primer hijo del div
                }
                else {
                    divAlerta.classList.remove("alert-success", "alert-danger")
