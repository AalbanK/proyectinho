...
const urlInformeStock = '/reportes/ventas';
const titulo_reporte = 'Ventas según Cliente / Producto'
...
$(document).ready(function(){
    ...
    document.querySelector('#parametros_ventas').addEventListener('submit', function(e) {
        ...
        let cliente = document.querySelector('#inputCliente');
        ...
        parametros_dt.Cliente = parametros.cliente ? (cliente.options[cliente.selectedIndex].text) : 'Todos' // Muestra el texto "Todos" si no se pasó el parámetro, caso contrario muestra el texto de la opción seleccionada en el select
        ...
        .then(json => {
            ...
            columnas = [
                ...
                { title: "ID Cliente", data: "idcliente" },
                { title: "Cliente", data: "descripcion_cliente" },
            ...
            inicializarDataTable(tablaVentas, datos, columnas, urlEspanholDT, parametros_dt, titulo_reporte)
                })
        .catch(error => {
            datos = [];
