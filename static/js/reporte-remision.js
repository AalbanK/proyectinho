...
const urlInformeRemision = '/reportes/remisiones';
const titulo_reporte = 'Remisiones según Producto'
...
$(document).ready(function(){
    ...
    tablaRemisiones = $("#productos_remision");
    ...
    document.querySelector('#parametros_remision').addEventListener('submit', function(e) {
        ...
        .then(json => {
            ...
            columnas = [
                ...
                { title: "Chapa 2", data: "chapacarreta" },
                { title: "Neto Origen", data: "neto" },
                { title: "Neto Destino", data: "netod" },
            ]
            inicializarDataTable(tablaRemisiones, datos, columnas, urlEspanholDT, parametros_dt, titulo_reporte)
                })
        .catch(error => {
            datos = [];
