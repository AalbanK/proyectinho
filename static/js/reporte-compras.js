...
const urlInformeStock = '/reportes/compras';
const titulo_reporte = 'Compras según Proveedor / Producto'
...
$(document).ready(function(){
    ...
    tablaCompras = $("#compras_proveedores");
    ...
    document.querySelector('#parametros_compras').addEventListener('submit', function(e) {
        ...
        let proveedor = document.querySelector('#inputProveedor');
        ...
        parametros_dt.Proveedor = parametros.proveedor ? (proveedor.options[proveedor.selectedIndex].text) : 'Todos' // Muestra el texto "Todos" si no se pasó el parámetro, caso contrario muestra el texto de la opción seleccionada en el select
        ...
        .then(json => {
            ...
            columnas = [
                ...
                { title: "ID Proveedor", data: "idproveedor" },
                { title: "Proveedor", data: "descripcion_proveedor" },
                { title: "Nro Factura", data: "numero" },
                { title: "ID Producto", data: "idproducto" },
                { title: "Producto", data: "descripcion_producto" },
                { title: "Cantidad", data: "cantidad" },
                { title: "Subtotal", data: "subtotal" }
            ]
            inicializarDataTable(tablaCompras, datos, columnas, urlEspanholDT, parametros_dt, titulo_reporte)
                })
        .catch(error => {
            datos = [];
